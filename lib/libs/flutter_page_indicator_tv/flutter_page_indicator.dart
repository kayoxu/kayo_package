...
class WarmPainter extends BasePainter {
  ...
  void draw(Canvas canvas, double space, double size, double radius) {
    double progress = page.toDouble() - index;
...
class DropPainter extends BasePainter {
  DropPainter(PageIndicator widget, int page, int index, Paint paint)
      : super(widget, page, index, paint);
...
class NonePainter extends BasePainter {
  NonePainter(PageIndicator widget, int page, int index, Paint paint)
      : super(widget, page, index, paint);
...
class SlidePainter extends BasePainter {
  SlidePainter(PageIndicator widget, int page, int index, Paint paint)
      : super(widget, page, index, paint);
...
class ScalePainter extends BasePainter {
  ScalePainter(PageIndicator widget, int page, int index, Paint paint)
      : super(widget, page, index, paint);
...
class ColorPainter extends BasePainter {
  ColorPainter(PageIndicator widget, int page, int index, Paint paint)
      : super(widget, page, index, paint);
...
abstract class BasePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    double page = this.page.toDouble();
    if (page < index) {
      page = 0.0;
    }
    _paint.color = widget.activeColor;
...
class _PageIndicatorState extends State<PageIndicator> {
  ...
  void _onController() {
    num page = widget.controller.page;
    index = page.floor();
