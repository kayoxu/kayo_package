...
class TransformerPageController extends MPPageController {
  final bool loop;
  final int itemCount;
  final bool reverse;
  ...
  double? get realPage {
    double? page;
    page = super.page.toDouble();

    return page;
  }

  static _getRenderPageFromRealPage(double? page, bool loop, int? itemCount,
      bool reverse) {
    double? renderPage;
    if (loop) {
...
class TransformerPageView extends StatefulWidget {
  ...
  factory TransformerPageView.children({Key? key,
    int? index,
    Duration? duration,
  ...
  static int? getRealIndexFromRenderIndex({required bool reverse,
    required int index,
  ...
  static MPPageController createPageController({required bool reverse,
    required int index,
    required int itemCount,
    required bool loop,
    required double viewportFraction}) {
    return new MPPageController(
...
class _TransformerPageViewState extends State<TransformerPageView> {
    ...
    return new AnimatedBuilder(
        ...
        builder: (BuildContext c, Widget? w) {
          ...
          TransformInfo info = new TransformInfo(
              ...
              forward: /*_pageController!.position.pixels -*/ _currentPixels! >=
                  0,
              done: _done,
  ...
  Widget build(BuildContext context) {
    ...
    // Widget child = new MPPageView.builder(
    //   itemBuilder: builder,
    ...
    Widget child = new MPPageView (children: [],);
  ...
  void onChangeNotifier() {
    ...
    if (widget.controller!.animation) {
      _pageController!
          .animateToPage(
          index!, duration: widget.duration, curve: widget.curve);
