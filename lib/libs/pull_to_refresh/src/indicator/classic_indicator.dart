...
class ClassicHeader extends RefreshIndicator {
  ...
  const ClassicHeader({
    ...
    this.spacing: 15.0,
    this.refreshingIcon,
    this.failedIcon: const MPIcon(MaterialIcons.error, color: Colors.grey),
    this.completeIcon: const MPIcon(MaterialIcons.done, color: Colors.grey),
    this.idleIcon = const MPIcon(
        MaterialIcons.arrow_downward, color: Colors.grey),
    this.releaseIcon = const MPIcon(MaterialIcons.refresh, color: Colors.grey),
  }) : super(
    key: key,
...
class ClassicFooter extends LoadIndicator {
  ...
  const ClassicFooter({
    ...
    this.loadingIcon,
    this.canLoadingIcon: const MPIcon(
        MaterialIcons.autorenew, color: Colors.grey),
    this.idleIcon = const MPIcon(
        MaterialIcons.arrow_upward, color: Colors.grey),
  }) : super(
    key: key,
    loadStyle: loadStyle,
    height: height,
