...
class _MaterialClassicHeaderState
  ...
  void didChangeDependencies() {
    ...
    _valueColor = _positionController.drive(
      ColorTween(
        begin: (widget.color ?? BaseColorUtils.colorAccent).withOpacity(0.0),
        end: (widget.color ?? BaseColorUtils.colorAccent).withOpacity(1.0),
      ).chain(
        ...
        children: <Widget>[
          CustomPaint(
            painter: _BezierPainter(
                ...
                color:
                widget.backgroundColor ?? BaseColorUtils.colorAccent),
            child: Container(),
          ),
          CustomPaint(
