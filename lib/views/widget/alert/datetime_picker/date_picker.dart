...
class DatePicker {
  ...
  static void showDatePicker(
    ...
    if (context.isDark) {
      Color backgroundColor = pickerTheme.backgroundColor;
      if (backgroundColor == DATETIME_PICKER_BACKGROUND_COLOR) {
        backgroundColor = BaseColorUtils.darkWhite(context: context);
      }

      TextStyle itemTextStyle = pickerTheme.itemTextStyle;
      if (itemTextStyle == DATETIME_PICKER_ITEM_TEXT_STYLE) {
        itemTextStyle = TextStyle(
            color: BaseColorUtils.darkBlack(context: context), fontSize: 16.0);
      }

      TextStyle cancelTextStyle = pickerTheme.cancelTextStyle ??
          TextStyle(
              color: BaseColorUtils.darkBlackLite(context: context),
              fontSize: 16.0);

      TextStyle confirmTextStyle = pickerTheme.confirmTextStyle ??
          TextStyle(color: BaseColorUtils.colorAccent, fontSize: 16.0);

      pickerTheme = pickerTheme.copyWith(
    ...
    if (locale != null) {
      return Localizations(
        ...
        delegates: [
          ...
          KayoPackageLocalizations.delegate,
        ],
        child: bottomSheet,
      );
    }
