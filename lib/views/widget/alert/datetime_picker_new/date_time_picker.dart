...
class DateTimePicker {
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    _inkWell(context,
                        height: heightTitle,
                        title: DatePickerI18n.getLocaleDone(locale), onTap: () {
                ...
                LineView(height: .5,color: BaseColorUtils.darkWindow(context: context).dark,),
                showEnd != true
                    ? SizedBox(
                        height: 0,
                        width: 0,
  ...
  static Container _titleTime(
      BuildContext context, double heightTitleTime, String? title) {
    return Container(
