...
showPrivacyDialog(BuildContext context,
    ...
    Function()? onCancel,
    Function()? onDone}) {
  final l10n = KayoPackageLocalizations.of(context);
  userTitle = userTitle ?? l10n?.userAgreementTitle ?? '《User Agreement》';
  privacyTitle = privacyTitle ?? l10n?.privacyPolicyTitle ?? '《Privacy Policy》';

  String _data = l10n?.privacyData(userTitle, privacyTitle) ??
      "Thank you for your support! Please read $userTitle and $privacyTitle carefully.";
