...
class NumberKeyboard extends StatelessWidget{
  static const FlutterCKTextInputType inputType = const FlutterCKTextInputType(name:'CKNumberKeyboard');
  static double getHeight(BuildContext ctx){
    MediaQueryData mediaQuery = MediaQuery.of(ctx);
    return mediaQuery.size.width / 3 / 2 * 4;
  }
  final FlutterKeyboardController controller ;
  const NumberKeyboard({this.controller});

  static register(){
    FlutterKeyboard.addKeyboard(NumberKeyboard.inputType,FlutterKeyboardConfig(builder: (context,controller, params){
