...
class FlutterKeyboardRootWidget extends StatefulWidget {
  final Widget child;

  /// The text direction for this subtree.
  final TextDirection textDirection;

  const FlutterKeyboardRootWidget(
  ...
  State<StatefulWidget> createState() {
    ...
    return FlutterKeyboardRootState();
  }
}

class FlutterKeyboardRootState extends State<FlutterKeyboardRootWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return FlutterKeyboardMediaQuery(child: Builder(builder: (context) {
      FlutterKeyboard.init(this, context);
