...
//           height: 1 == widget.maxLines ? 42 : null,
          ...
          child: TextField(
              ...
              style: null == widget.textStyle
                  ? TextStyle(
                      color: widget.textColor?.toDark(userDark: context.isDark),
                          ...
                          enabledBorder: true != widget.showBorder && true == widget.showLine
                              ? UnderlineInputBorder(
                                  borderSide: BorderSide(
                                      color: widget.lineColor?.toDark(userDark: context.isDark) ??
                                          BaseColorUtils.colorGreyLiteLite.toDark(
                                  ...
                                  borderSide: BorderSide(
                                      color: widget.lineColor?.toDark(userDark: context.isDark) ??
                                          BaseColorUtils.colorGreyLiteLite
                                              .toDark(userDark: context.isDark)!))
                              : InputBorder.none,
                          border: true != widget.showBorder && true == widget.showLine ? UnderlineInputBorder(borderSide: BorderSide(color: widget.lineColor?.toDark(userDark: context.isDark) ?? BaseColorUtils.colorGreyLiteLite.toDark(userDark: context.isDark)!)) : InputBorder.none))),
        ),
      ),
    );
  }
