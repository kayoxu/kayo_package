...
enum KayoInputTypeCommon { carNo, carNoAbc, cardId, number, phone }

class KeyboardCommon extends StatefulWidget {
  final KeyboardController controller;
  KayoInputTypeCommon kayoInputTypeCommon;

  KeyboardCommon({this.controller, this.kayoInputTypeCommon});

  @override
  KeyboardCommonState createState() => KeyboardCommonState();
}

class KeyboardCommonState extends State<KeyboardCommon> {
  var stream;
  ...
  change(tyep) {
    setState(() {
      widget.kayoInputTypeCommon = tyep;
    });
  }
  ...
  void keyboardHandleFunction(KayoInputTypeCommon KayoInputTypeCommon) {
    change(KayoInputTypeCommon);
  }

  @override
  Widget build(BuildContext context) {
    getView() {
      if (widget.kayoInputTypeCommon == KayoInputTypeCommon.carNo) {
        return carno();
      } else if (widget.kayoInputTypeCommon == KayoInputTypeCommon.carNoAbc) {
        return abc();
      } else if (widget.kayoInputTypeCommon == KayoInputTypeCommon.cardId) {
        return abc1();
      } else if (widget.kayoInputTypeCommon == KayoInputTypeCommon.number) {
        return abcNumber();
      } else if (widget.kayoInputTypeCommon == KayoInputTypeCommon.phone) {
        return abcPhone();
      }
    }
...
//              padding: EdgeInsets.only(left: 4, top: 4, right: 4, bottom: 4),
                  ...
                  onTap: () {
                    change(KayoInputTypeCommon.carNoAbc);
                  })),
        ...
        children: <Widget>[
          Expanded(
              ...
              child: Clickable(
                  ...
                  onTap: () {
                    change(KayoInputTypeCommon.carNo);
                  })),
